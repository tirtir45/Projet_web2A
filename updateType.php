            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-primary" href="#">
                        ...
                        <span class="nav-link-text ms-1">Configuration des types de produits </span>
                    </a>
                </li>
                ...
                <div class="col-md-7 mt-4">
                    <div class="card">
                        <div class="card-header pb-0 px-3">
                            <h6 class="mb-0"> Modification de Type </h6>
                        </div>
                        <div class="card-body pt-4 p-3">
                            <div class="card-header pb-0 p-3">
                                <div class="row">
                                    <div class="col-6 d-flex align-items-center">
                                        <h6 class="mb-0">Mise a jour du Type de produit </h6>
                                    </div>
                                    <div class="col-6 text-end">
                                        <button class="btn btn-outline-primary btn-sm mb-0"> <a href="listeType.php">
                                                Retour
                                                à la liste </a></button>
                                        <?php
                                        if (isset($_GET['id'])) {
                                            $oldtype = $typec->showType($_GET['id']);
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body p-3 pb-0">
                                        ...
                                        <ul class="list-group">
                                            <li
                                                ...
                                                <div class="d-flex flex-column">
                                                    <h6 class="mb-1 text-dark font-weight-bold text-sm">
                                                        <label for="quantity">Type_produit :</label>
                                                    </h6>
                                                    <input type="text" id="type_produit" name="type_produit"
                                                        value="<?php echo $oldtype['type_produit']; ?>" />
                                                </div>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="list-group">
                                            <li
                                                ...
                                                <div class="d-flex flex-column">
                                                    <h6 class="mb-1 text-dark font-weight-bold text-sm">
                                                        <label for="quantity">Produit_id :</label>
                                                    </h6>
                                                    <input type="text" id="produit_id" name="produit_id"
                                                        value="<?php echo $oldtype['produit_id']; ?>" />
                                                </div>
                                            </li>
                                        </ul>
