...
$role = $_SESSION['role'];
$firstname = $_SESSION['firstname'];  // Si vous avez stocké d'autres informations comme le prénom
$lastname = $_SESSION['lastname'];    // Idem pour le nom
                  ...
                  >
                    <div class="main-menu">
                      <nav id="mobile-menu">
                        ...
                        <?php if ( $role == 'admin') {?>
    <li class="has-dropdown">
        <a href="http://localhost/Tste/php/Views/Frontoff/index.php">Profile</a>
        <ul class="submenu">
            <li><a href="listuser.php">Management</a></li>
        </ul>
    </li>
<?php } else { ?>
    <li>
...
<?php } ?>
                          ...
                          <a href="http://localhost/Tste/php/Views/Frontoff/index.php">Shop</a>
                                <ul class="submenu">
                                    ...
                                    <li><a href="../Frontoff/cart.php">Cart</a></li>
                                </ul>
                          </li>
                            <li class="has-dropdown">
                          <a href="index.php">Dicover Tunisia</a>
                                <ul class="submenu">
                                    <li><a href="../Frontoff/Home.php">Events</a></li>
                                    <li><a href="../Frontoff/Reservations.php">Reservations</a></li>
                                </ul>
                          </li>
                          <li class="has-dropdown">
                            <a href="../Frontoff/view.php">Blog</a>
                          </li>
                          <li>
   ...
   <div class="container">
    ...
    <!-- Ajouter un lien pour déconnexion -->

    <!-- Ajouter un bouton pour mettre à jour le profil -->
    <br><br>
    <a href="update_profile.php" class="btn btn-primary">Mettre à jour le profil</a>

    <!-- Ajouter un lien pour supprimer le compte -->
    <br><br>
   
    <a href="delete_account.php" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer votre compte? Cette action est irréversible.');">Supprimer le compte</a>
<br>
<br>
<a href="desactivateaccount.php" 
   class="btn btn-warning" 
   onclick="return confirm('Êtes-vous sûr de vouloir désactiver votre compte pendant 30 jours ?');">
