...
<form method="POST" action="" id="loginForm" onsubmit="return validateForm()">
    ...
    <div class="g-recaptcha" data-sitekey="6Ld4I5gqAAAAACrphR9cwteeL51gQgiGwBahQyGu"></div>
...
<script>
    function validateForm() {
        ...
        // Vérifier si reCAPTCHA est complété
        const recaptchaResponse = grecaptcha.getResponse();
        if (recaptchaResponse.length === 0) {
            alert("Veuillez compléter le reCAPTCHA.");
            return false; // Empêche la soumission si reCAPTCHA n'est pas rempli
        }
