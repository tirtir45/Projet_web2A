<?php
session_start();
require_once(__DIR__ . '/../../connect.php'); // Ensure correct path to config.php
              ...
              >
                ...
                <div class="header-lang-item tp-header-setting">
                  ...
                  <ul>
                    ...
                    <li>
                      <a class="furniture-clr-hover" href="../Frontoff/cart.php">Cart</a>
                    </li>
                    <li>
                    ...
                    <div class="main-menu">
                      <nav id="mobile-menu">
                        <ul>
                          ...
                          <li class="has-dropdown">
                          <a href="../Frontoff/index.php">Shop</a>
                                <ul class="submenu">
                                    <li><a href="../Frontoff/index.php">Product</a></li>
        ...
        <nav>
            <ul>
               <li><a href="manage.php">My Blogs</a></li>
                <li><a href="indexB.php">Create</a></li>
                <li><a href="../Frontoff/index.php">Home Page</a></li>
                <li><a href="#">Shop</a></li>
            </ul>
        </nav>
    </header>
                    ...
                    <?php foreach ($blogs as $blog): ?>
                        <div class="blog-item">
                            ...
                            <ul class="comment-list">
                                ...
                                $stmt->bindParam(':blog_id', $blog['id'], PDO::PARAM_INT);
                                $stmt->execute();
                                ...
                                if (!empty($comments)): ?>
                                    <?php foreach ($comments as $comment): ?>
                                        <li class="comment-item">
                                            ...
                                            <small class="comment-date">(<?= htmlspecialchars($comment['created_at']) ?>)</small>
                                        </li>
                                    <?php endforeach; ?>
                                <?php else: ?>
                            ...
                            <div id="comment-form-container">
                                ...
                                <?php else: ?>
                                    <p>You must <a href="../usrview/login.php">log in</a> to leave a comment.</p>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php endforeach; ?>
