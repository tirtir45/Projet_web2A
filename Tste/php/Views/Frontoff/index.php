            ...
            <div class="offcanvas__content">
               <div class="offcanvas__top mb-40 d-flex justify-content-between align-items-center">
                  <div class="offcanvas__logo">
                     <a href="index.php">
                        <img src="../../Assets/imgs/furniture/logo/new.png">
                     </a>
                  </div>
                  ...
                  <div class="row g-5 align-self-end">
                    <div class="col-xxl-6 col-lg-6">
                      <div class="banner-content-4 furniture__content">
                        ...
                        <div class="banner-btn-wrapper furniture__btn-group">
                          <a class="solid-btn" href="index.php"
                            >Buy Now<span
                              ><i class="fa-regular fa-angle-right"></i></span
                          ></a>
                          <a
            ...
            <div class="col-lg-6">
              ...
              >
                ...
                <button type="button" class="add-to-cart"
                                data-name="Collier poisson" 
                                data-price="19.25"
                                data-image="../../assets/imgs/furniture/product/pp.png">
                                <span class="solid-btn mt-30" class="fa-reguladiva-angle-right">BUY NOW</span>
                              </button>
              </a>
            </div>
            <div class="col-lg-6">
              ...
              >
                ...
                <button type="button" class="add-to-cart"
                                data-name="Collier Khomssa" 
                                data-price="19.25"
                                data-image="../../Assets/imgs/furniture/product/vv2.png">
                                <span class="solid-btn mt-30" class="fa-reguladiva-angle-right">BUY NOW</span>
                              </button>
              </a>
            </div>
                      ...
                      <div class="product-item furniture__product">
                        ...
                        <div class="product-thumb theme-bg-2">
                          ...
                          <div class="product-action-item">
                            <button type="button" class="product-action-btn add-to-cart"
                                ...
                                data-price="19.25" 
                                data-image="/php/assets/imgs/furniture/product/jj.png">
                        ...
                        <div class="product-content">
                          ...
                          <div class="product-price">
                            <span class="product-new-price">159 DT</span>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="product-item furniture__product">
                        <div class="product-thumb theme-bg-2">
                          ...
                          <button type="button" class="product-action-btn add-to-cart"
                                    ...
                                    data-price="30.25" 
                                    data-image="../../assets/imgs/furniture/product/ss.png">
                                <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M13.0768 10.1416C13.0768 11.9228 11.648 13.3666 9.88542 13.3666C8.1228 13.3666 6.69401 11.9228 6.69401 10.1416M1.375 5.84163H18.3958M1.375 5.84163V12.2916C1.375 19.1359 2.57494 20.3541 9.88542 20.3541C17.1959 20.3541 18.3958 19.1359 18.3958 12.2916V5.84163M1.375 5.84163L2.91454 2.73011C3.27495 2.00173 4.01165 1.54163 4.81754 1.54163H14.9533C15.7592 1.54163 16.4959 2.00173 16.8563 2.73011L18.3958 5.84163" 
                                          stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                    ...
                    <div class="swiper-slide">
                      <div class="product-item furniture__product">
                        ...
                        <div class="product-thumb theme-bg-2">
                          ...
                          <div class="product-action-item">
                            <button type="button" class="product-action-btn add-to-cart"
                                    ...
                                    data-price="30.25" 
                                    data-image="/php/assets/imgs/furniture/product/mm.png">
                                <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M13.0768 10.1416C13.0768 11.9228 11.648 13.3666 9.88542 13.3666C8.1228 13.3666 6.69401 11.9228 6.69401 10.1416M1.375 5.84163H18.3958M1.375 5.84163V12.2916C1.375 19.1359 2.57494 20.3541 9.88542 20.3541C17.1959 20.3541 18.3958 19.1359 18.3958 12.2916V5.84163M1.375 5.84163L2.91454 2.73011C3.27495 2.00173 4.01165 1.54163 4.81754 1.54163H14.9533C15.7592 1.54163 16.4959 2.00173 16.8563 2.73011L18.3958 5.84163" 
                                          stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                        ...
                        <div class="product-content">
                          ...
                          <div class="product-price">
                            <span class="product-new-price">299 DT</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="swiper-slide">
                      <div class="product-item furniture__product">
                        <div class="product-thumb theme-bg-2">
                          ...
                          <div class="product-action-item">
                              <button type="button" class="product-action-btn add-to-cart"
                                  data-name="Bracelet Boule En Céramique" 
                                  data-price="19.25" 
                                  data-image="../../assets/imgs/furniture/product/bb.png">
                                  <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                      <path d="M13.0768 10.1416C13.0768 11.9228 11.648 13.3666 9.88542 13.3666C8.1228 13.3666 6.69401 11.9228 6.69401 10.1416M1.375 5.84163H18.3958M1.375 5.84163V12.2916C1.375 19.1359 2.57494 20.3541 9.88542 20.3541C17.1959 20.3541 18.3958 19.1359 18.3958 12.2916V5.84163M1.375 5.84163L2.91454 2.73011C3.27495 2.00173 4.01165 1.54163 4.81754 1.54163H14.9533C15.7592 1.54163 16.4959 2.00173 16.8563 2.73011L18.3958 5.84163"
                                          stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                  </svg>
                        ...
                        <div class="product-content">
                          ...
                          <div class="product-price">
                            <span class="product-new-price">49 DT</span>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div class="tab-content" id="nav-tabContent">
              ...
              <div class="product-item">
                  ...
                  <div class="product-info">
                      ...
                      <p class="product-quantity">Quantity: <?php echo htmlspecialchars($product['quantity']); ?></p>
                      <button type="button" class="product-action-btn add-to-cart"
                        data-id="<?php echo $product['id']; ?>"
                        data-name="Bracelet cristal de roche" 
                                    data-price="30.25" 
                                    data-image="../../assets/imgs/furniture/product/pro.png">
                        <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M13.0768 10.1416C13.0768 11.9228 11.648 13.3666 9.88542 13.3666C8.1228 13.3666 6.69401 11.9228 6.69401 10.1416M1.375 5.84163H18.3958M1.375 5.84163V12.2916C1.375 19.1359 2.57494 20.3541 9.88542 20.3541C17.1959 20.3541 18.3958 19.1359 18.3958 12.2916V5.84163M1.375 5.84163L2.91454 2.73011C3.27495 2.00173 4.01165 1.54163 4.81754 1.54163H14.9533C15.7592 1.54163 16.4959 2.00173 16.8563 2.73011L18.3958 5.84163"
                                  stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
          ...
          <div class="row g-4">
            <div class="col-xxl-7 col-xl-6">
              <div
                ...
                data-background="../../assets/imgs/furniture/ad/ad.png"
              >
                <div class="fad-content">
                  <h6 class="text-white mb-20 text-uppercase">
                    HOT DEAL Items
                  </h6>
                  <h2 class="text-capitalize text-black">
                    LIBRE YVES <br />
                    30% Off
                  </h2>
                  <button class="border__btn-f mt-35" 
                          onclick="scrollPageUp();">
                          Visit Now<span><i class="fa-regular fa-angle-right"></i></span>
                  </button>

                  <script>
                      function scrollPageUp() {
                          window.scrollBy({
                              top: -1020, // Scroll up by 100 pixels
                              left: 0,
            ...
            <div class="col-xxl-5 col-xl-6">
              <div
                class="furniture-ad__item h-100 bg-image"
                data-background="../../assets/imgs/furniture/product/bague2.png"
              >
                <div class="fad-content fad-timer text-center">
                  ...
                  <button class="border__btn-f mt-35 click-lift-btn" 
                          onclick="scrollPageUp1();">
                          Buy Now<span><i class="fa-regular fa-angle-right"></i></span>
                  </button>

                  <script>
                      function scrollPageUp1() {
                          window.scrollBy({
                              top: -1800, // Scroll up by 100 pixels
                              left: 0,
                              behavior: 'smooth' // Smooth scroll effect
                          });
                      }
...
<section
  ...
  style="
    background-image: url('../../Assets/imgs/furniture/testimonial/bg.png');
        ...
        <div class="swiper-slide">
          <div class="furniture-testimonial__item">
            <div class="ft-head">
              ...
              >
                <path
                  d="M23.9729 40C23.9729 37.384 23.9729 34.7679 23.9729 32.0675C27.1379 32.1519 29.7642 30.8861 31.717 27.7637C32.7945 26.076 33.5352 23.7131 33.5352 21.8565C29.8989 21.8565 26.1952 21.8565 22.4915 21.8565C22.4915 14.5148 22.4915 7.25738 22.4915 0C28.2827 0 34.0739 0 39.9325 0C39.9325 7.34177 39.9325 14.0084 39.9325 20.5907C39.9325 29.9578 35.084 37.5527 27.8113 39.5781C26.5992 40 25.3197 40.0844 23.9729 40Z"
                  fill="#B18B5E"
                />
              </svg>
            </div>
            <p>
              Je suis tombée amoureuse de leurs bagues ! Elles sont élégantes,
              brillantes et parfaitement ajustées. Je reçois des compliments à
              chaque fois que je les porte. Merci pour ces bijoux magnifiques !
            </p>
          </div>
        </div>
          ...
          <div class="furniture-testimonial__item">
            <div class="ft-head">
              <div class="ft-info">
                ...
                <h5>Med Seif eddine berriche</h5>
            ...
            <p>
              Une expérience exceptionnelle ! Le design et la qualité des
              produits sont impressionnants. Je recommande vivement cette
              boutique.
            </p>
          </div>
        </div>
          ...
          <div class="row g-4">
            <div class="col-xl-4 col-lg-6 col-md-6">
              <div class="furniture-seller__item">
                <div class="fs-image">
                  <img src="../../assets/imgs/furniture/product/yy.png" alt="" />
                </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
              <div class="furniture-seller__item">
                <div class="fs-image">
                  <img src="../../assets/imgs/furniture/product/bague2.png" alt="" />
                </div>
                <div class="fs-content">
                  <h5>
                    <a href="product-details.html" class="text-capitalize"
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
              <div class="furniture-seller__item">
                <div class="fs-image">
                  <img src="../../assets/imgs/furniture/product/xx.png" alt="" />
                </div>
                <div class="fs-content">
                  <h5>
                    <a href="product-details.html" class="text-capitalize"
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
              <div class="furniture-seller__item">
                <div class="fs-image">
                  <img src="../../assets/imgs/furniture/product/pp.png" alt="" />
                </div>
                <div class="fs-content">
                  <h5>
                    <a href="product-details.html" class="text-capitalize"
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
              <div class="furniture-seller__item">
                <div class="fs-image">
                  <img src="../../assets/imgs/furniture/product/pro.png" alt="" />
                </div>
                <div class="fs-content">
                  <h5>
                    <a href="product-details.html" class="text-capitalize"
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
              <div class="furniture-seller__item">
                <div class="fs-image">
                  <img src="../../assets/imgs/furniture/product/seif.png" alt="" />
                </div>
                <div class="fs-content">
                  <h5>
                    <a href="product-details.html" class="text-capitalize"
          ...
          <div class="row gy-5">
              ...
              <div class="blog-item-4 furniture__blog-item">
                <div class="blog-content-4">
                  <div class="blog-tag-wrapper mb-15">
                    <a class="blog-tag" href="#">Ring</a>
                  </div>
                  <div class="postbox__meta mb-15">
                    <span><a href="#">By Elaa Derouich</a></span>
                    <span>18 Dec, 2024 13:05</span>
                  </div>
                  <h4 class="blog-title">
                    <a href="blog-details.html" class="text-capitalize"
                      >Qualité top , rab7tni 10k fl insta</a
                    >
                  </h4>
                ...
                <div class="blog-item-thumb w-img">
                  <a href="blog-details.html">
                    <img
                      src="../../assets/imgs/furniture/blog/elaa.png"
                      alt=""
                    />
                  </a>
                </div>
            ...
            <div class="col-xxl-6 col-xl-6 col-lg-6">
              <div class="blog-item-4 furniture__blog-item">
                <div class="blog-content-4">
                  <div class="blog-tag-wrapper mb-15">
                    <a class="blog-tag" href="#">Collier</a>
                  </div>
                  <div class="postbox__meta mb-15">
                    <span><a href="#">By Elaa Derouich (#1 customer)</a></span>
                    <span>18 Dec, 2024 19:25</span>
                  </div>
                  <h4 class="blog-title">
                    <a href="blog-details.html" class="text-capitalize"
                      >cherka trab7ek 7asanet meli lbestha se7r lkolou mche</a
                    >
                  </h4>
                  <a class="round-link" href="blog-details.html"
                    ><i class="fa-regular fa-angle-right"></i
                ...
                <div class="blog-item-thumb-4 w-img">
                  <a href="blog-details.html">
                    <img
                      src="../../assets/imgs/furniture/blog/elaa2.png"
                      alt=""
                    />
                  </a>
                </div>
            ...
            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
              <div class="support-item">
                <div class="support-content">
                  ...
                  <a class="join-btn furniture-btn" href="../../usrview/signup.php"
                    >sign up<span
                      ><i class="fa-regular fa-angle-right"></i></span
                  ></a>                     
                </div>
            ...
            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
              <div class="support-item is-light-yellow">
                <div class="support-content">
                  ...
                  <p>Get weekly deals, valuable health information and more.</p>
                  <a class="join-btn furniture-btn" href="https://www.facebook.com/profile.php?id=61568903216448"
                    >FOLLOW NOW<span
                      ><i class="fa-regular fa-angle-right"></i></span
                  ></a>
                </div>
