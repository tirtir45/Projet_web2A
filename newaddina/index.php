...
// Sample product data (you can fetch this from a database in a real application)
$products = [
    [
        'name' => 'Bracelet en quartz framboise',
        'price' => '19.25',
        'image' => 'assets/imgs/furniture/product/jj.png'
     ],
    [
        'name' => 'Bracelet Turquoise',
        'price' => '30.35',
        'image' => 'assets/imgs/furniture/product/ss.png' // Replace with actual image path
     ],
    [
      'name' => 'Bracelet en céramique violet',
      'price' => '30.35',
      'image' => 'assets/imgs/furniture/product/mm.png' // Replace with actual image path
     ],
    [
      'name' => 'Bracelet en rubis zoisite',
      'price' => '30.35',
      'image' => 'assets/imgs/furniture/product/hh.png' // Replace with actual image path
     ],
    [
      'name' => 'Bracelet cristal de roche',
      'price' => '30.35',
      'image' => 'assets/imgs/furniture/product/pro.png' // Replace with actual image path
     ],
     [
      'name' => 'Bracelet en quartz Rouge',
      'price' => '19.25',
      'image' => 'assets/imgs/furniture/product/yy.png'
    ],
    [
      'name' => 'Bracelet Onyx',
      'price' => '30.35',
      'image' => 'assets/imgs/furniture/product/uu.png' // Replace with actual image path
    ],
    [
    'name' => 'Bracelet en céramique gris et blanc',
    'price' => '30.35',
    'image' => 'assets/imgs/furniture/product/dd.png' // Replace with actual image path
    ],
...
<html class="no-js" lang="zxx">
  ...
  <?php require_once 'connect.php'; ?>
    ...
    <div
      class="product-modal-sm modal fade"
        ...
        <div class="modal-content">
          <div class="product-modal">
            <div class="product-modal-wrapper p-relative">
              <button
                type="button"
                class="close product-modal-close"
                ...
                <div class="bd__shop-details-inner">
                  <div class="row">
                    <div class="col-xxl-6 col-lg-6">
                      <div
                        class="product__details-thumb-wrapper d-sm-flex align-items-start"
                      >
                        <div class="product__details-thumb-tab mr-20">
                          <nav>
                            <div
                              class="nav nav-tabs flex-nowrap flex-sm-column"
                              id="nav-tab"
                              role="tablist"
                            >
                              <button
                      ...
                      <div class="product__details-content">
                        ...
                        <div class="product__details-action mb-35">
                          ...
                          <div class="product__add-wish">
                            <a href="#" class="product__add-wish-btn"
              ...
              >
                ...
                <div class="header-lang-item tp-header-setting">
                  ...
                  <ul>
                    ...
                    <li>
                      <a class="furniture-clr-hover" href="wishlist.html"
                        >Wishlist</a
                      >
                    </li>
                    <li>
    ...
    <main>
      <!-- Banner area start -->
      <section
        class="banner-4 p-relative furniture-banner-area fix bg-image pb-100"
                  ...
                  <div class="row g-5 align-self-end">
                    <div class="col-xxl-6 col-lg-6">
                      <div class="banner-content-4 furniture__content">
                        ...
                        <p>
                          A website that helps tourists to help them find their
                          needs easily and improve the quality of tourism in
                          Tunisia.
                        </p>
                    ...
                    <div class="col-xxl-6 col-lg-6">
                      <div class="banner-thumb-wrapper-4 p-relative">
                        <div class="banner-thumb-4 p-relative z-index-1">
                          <img
                            src="assets/imgs/furniture/banner/toutou.png"
                            alt="image"
                          />
                        </div>
                  ...
                  <div class="row g-5 align-self-end">
                    <div class="col-xxl-6 col-lg-6">
                      <div class="banner-content-4 furniture__content">
                        ...
                        <h2 class="banner-title-4">
                          Khomsa ou khmiss <br />
                          Top selling website 2024
                        </h2>
                        <p>
                          Nominated more than 5 times best selling website ,
                          This year they hold the record of the best selling
                          items in Tunisia.
                        </p>
                        <div class="banner-btn-wrapper furniture__btn-group">
                          <a class="solid-btn" href="product-details.html"
                    ...
                    <div class="col-xxl-6 col-lg-6">
                      <div class="banner-thumb-wrapper-4 p-relative">
                        <div class="banner-thumb-4 p-relative z-index-1">
                          <img
                            src="assets/imgs/furniture/banner/khomsa.png"
                            alt="image"
                          />
                        </div>
                        <div class="furniture-circle d-none d-lg-block">
                  ...
                  <div class="row g-5 align-self-end">
                    <div class="col-xxl-6 col-lg-6">
                      <div class="banner-content-4 furniture__content">
                        ...
                        <p>
                          Some people buy our items just to make a beautiful
                          collection others are seeing it as a source of money ,
                          profit unlikely for others who just buy them to look
                          cooler and if they didn't enjoy our product the get a
                    ...
                    <div class="col-xxl-6 col-lg-6">
                      <div class="banner-thumb-wrapper-4 p-relative">
                        <div class="banner-thumb-4 p-relative z-index-1">
                          <img
                            src="assets/imgs/furniture/banner/rass.png"
                            alt="image"
                          />
                        </div>
                        <div class="furniture-circle d-none d-lg-block">
          ...
          <div class="row g-4">
            <div class="col-lg-6">
              <a
                ...
                data-background="assets/imgs/furniture/product/vv.png"
              >
                <span class="fo-discount">GET 30% OFF</span>
                <h3 class="text-capitalize">
                  Collier poisson avec <br />Ambre <br />
                </h3>
            ...
            <div class="col-lg-6">
              <a
                href="product-details.html"
                class="furniture-off__item bg-image d-block"
                data-background="assets/imgs/furniture/product/vv2.png"
              >
                ...
                <div class="solid-btn mt-30">
                  Buy Now<span><i class="fa-reguladiva-angle-right"></i></span>
                </div>
              </a>
            </div>
          </div>
                    ...
                    <div class="swiper-slide">
                      <div class="product-item furniture__product">
                        ...
                        <div class="product-thumb theme-bg-2">
                          <a href="product-details.html"
                            ><img
                              src="assets/imgs/furniture/product/jj.png"
                              alt=""
                          /></a>
                          <div class="product-action-item">
                            <a href="/addina/cart.html">
                        ...
                        <div class="product-content">
                          <h4 class="product-title">
                            <a href="product-details.html"
                              >Bracelet en quartz framboise</a
                            >
                          </h4>
                    ...
                    <div class="swiper-slide">
                      <div class="product-item furniture__product">
                        <div class="product-thumb theme-bg-2">
                          <a href="product-details.html"
                            ><img
                              src="assets/imgs/furniture/product/ss.png"
                              alt=""
                          /></a>
                          <div class="product-action-item">
                            <a href="/addina/cart.html">
                    ...
                    <div class="swiper-slide">
                      <div class="product-item furniture__product">
                        ...
                        <div class="product-thumb theme-bg-2">
                          <a href="product-details.html"
                            ><img
                              src="assets/imgs/furniture/product/mm.png"
                              alt=""
                          /></a>
                          <div class="product-action-item">
                            <a href="/addina/cart.html">
                        ...
                        <div class="product-content">
                          <h4 class="product-title">
                            <a href="product-details.html"
                              >Bracelet en céramique violet</a
                            >
                          </h4>
                          <div class="user-rating">
                            <i class="fal fa-star"></i>
                    ...
                    <div class="swiper-slide">
                      <div class="product-item furniture__product">
                        <div class="product-thumb theme-bg-2">
                          <a href="product-details.html"
                            ><img
                              src="assets/imgs/furniture/product/bb.png"
                              alt=""
                          /></a>
                          <div class="product-action-item">
                            <a href="/addina/cart.html">
        ...
        <div class="row g-0 align-items-center">
            ...
            <div class="furniture-rating__left-item">
              <div class="furniture-ad__item frl-item bg-furniture">
                <div class="fad-content">
                  <h6 class="text-white mb-20 text-uppercase">
                    HOT DEAL furniture
                  </h6>
                  ...
                  <a
                    class="border__btn-f mt-35 bg-white text-black"
                    href="product-details.html"
                    >Buy Now<span
                      ><i class="fa-regular fa-angle-right"></i></span
                  ></a>
          ...
          <div class="col-xl-6">
            <div class="furniture-rating__right-item">
              <img
                class="w-100"
                src="assets/imgs/furniture/rating/yy.png"
                alt="image"
              />
              ...
              <div class="rating-dot dot-two">
                ...
                <ul>
                  <li>
                    <h6>Bracelet en céramique violet</h6>
                  </li>
                  <li class="py-1">
                    <svg
                      width="116"
              ...
              <div class="rating-dot dot-three">
                ...
                <ul>
                  <li>
                    <h6>Bracelet en quartz framboise</h6>
                  </li>
                  <li class="py-1">
                    <svg
                      width="116"
      ...
      <section class="fruniture-trendy section-space">
        <div class="container">
          <div class="furniture-trendy__header">
            ...
            <div
              class="bd-product__filter-style furniture-trendy__tab nav nav-tabs"
              role="tablist"
            >
              <button
                class="nav-link active"
                        ...
                        <span class="product-trending">10% off</span>
                            ...
                            <div class="product-thumb theme-bg-2">
                              ...
                              <button type="button" class="product-action-btn add-to-cart"
                                data-name="Bracelet en quartz framboise" 
                                data-price="19.25" 
                                data-image="/newaddina/assets/imgs/furniture/product/jj.png">
                                ...
                                <button type="button" class="product-action-btn quick-view"
                                  data-bs-toggle="modal"
                                  data-bs-target="#producQuickViewModal"
                                  data-name="Bracelet en quartz framboise"
                                  data-price="19.25"
                                  data-image="/newaddina/assets/imgs/furniture/product/jj.png"
                                  data-description="Product description here.">
                  ...
                  <div class="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="product-item furniture__product">
                      <div class="product-thumb theme-bg-2">
                        ...
                        <div class="product-action-item">
                          <button type="button" class="product-action-btn add-to-cart"
                                    data-name="Bracelet Turquoise" 
                                    data-price="30.25" 
                                    data-image="/newaddina/assets/imgs/furniture/product/ss.png">
                                <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M13.0768 10.1416C13.0768 11.9228 11.648 13.3666 9.88542 13.3666C8.1228 13.3666 6.69401 11.9228 6.69401 10.1416M1.375 5.84163H18.3958M1.375 5.84163V12.2916C1.375 19.1359 2.57494 20.3541 9.88542 20.3541C17.1959 20.3541 18.3958 19.1359 18.3958 12.2916V5.84163M1.375 5.84163L2.91454 2.73011C3.27495 2.00173 4.01165 1.54163 4.81754 1.54163H14.9533C15.7592 1.54163 16.4959 2.00173 16.8563 2.73011L18.3958 5.84163" 
                                          stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                      ...
                      <div class="product-content">
                        <h4 class="product-title">
                          <a href="product-details.html">Bracelet Turquoise</a>
                        </h4>
                        <div class="user-rating mb-1">
                          <i class="far fa-star"></i>
                          <i class="far fa-star"></i>
                  ...
                  <div class="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="product-item furniture__product">
                      ...
                      <div class="product-thumb theme-bg-2">
                        ...
                        <div class="product-action-item">
                         <button type="button" class="product-action-btn add-to-cart"
                                    data-name="Bracelet en céramique violet" 
                                    data-price="30.25" 
                                    data-image="/newaddina/assets/imgs/furniture/product/mm.png">
                                <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M13.0768 10.1416C13.0768 11.9228 11.648 13.3666 9.88542 13.3666C8.1228 13.3666 6.69401 11.9228 6.69401 10.1416M1.375 5.84163H18.3958M1.375 5.84163V12.2916C1.375 19.1359 2.57494 20.3541 9.88542 20.3541C17.1959 20.3541 18.3958 19.1359 18.3958 12.2916V5.84163M1.375 5.84163L2.91454 2.73011C3.27495 2.00173 4.01165 1.54163 4.81754 1.54163H14.9533C15.7592 1.54163 16.4959 2.00173 16.8563 2.73011L18.3958 5.84163" 
                                          stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                  ...
                  <div class="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="product-item furniture__product">
                      <div class="product-thumb theme-bg-2">
                        <a href="product-details.html"
                          ><img
                            src="assets/imgs/furniture/product/hh.png"
                            alt=""
                        /></a>
                        <div class="product-action-item">
                          <button type="button" class="product-action-btn add-to-cart"
                                    data-name="Bracelet en rubis zoisite" 
                                    data-price="30.25" 
                                    data-image="/newaddina/assets/imgs/furniture/product/hh.png">
                                <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M13.0768 10.1416C13.0768 11.9228 11.648 13.3666 9.88542 13.3666C8.1228 13.3666 6.69401 11.9228 6.69401 10.1416M1.375 5.84163H18.3958M1.375 5.84163V12.2916C1.375 19.1359 2.57494 20.3541 9.88542 20.3541C17.1959 20.3541 18.3958 19.1359 18.3958 12.2916V5.84163M1.375 5.84163L2.91454 2.73011C3.27495 2.00173 4.01165 1.54163 4.81754 1.54163H14.9533C15.7592 1.54163 16.4959 2.00173 16.8563 2.73011L18.3958 5.84163" 
                                          stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                  ...
                  <div class="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="product-item furniture__product">
                      ...
                      <div class="product-thumb theme-bg-2">
                        <a href="product-details.html"
                          ><img
                            src="assets/imgs/furniture/product/pro.png"
                            alt=""
                        /></a>
                        <div class="product-action-item">
                          <button type="button" class="product-action-btn add-to-cart"
                                    data-name="Bracelet cristal de roche" 
                                    data-price="30.25" 
                                    data-image="/newaddina/assets/imgs/furniture/product/pro.png">
                                <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M13.0768 10.1416C13.0768 11.9228 11.648 13.3666 9.88542 13.3666C8.1228 13.3666 6.69401 11.9228 6.69401 10.1416M1.375 5.84163H18.3958M1.375 5.84163V12.2916C1.375 19.1359 2.57494 20.3541 9.88542 20.3541C17.1959 20.3541 18.3958 19.1359 18.3958 12.2916V5.84163M1.375 5.84163L2.91454 2.73011C3.27495 2.00173 4.01165 1.54163 4.81754 1.54163H14.9533C15.7592 1.54163 16.4959 2.00173 16.8563 2.73011L18.3958 5.84163" 
                                          stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                  ...
                  <div class="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="product-item furniture__product">
                      <div class="product-thumb theme-bg-2">
                        <a href="product-details.html"
                          ><img
                            src="assets/imgs/furniture/product/yy.png"
                            alt=""
                        /></a>
                        <div class="product-action-item">
                          <button type="button" class="product-action-btn add-to-cart"
                                    data-name="Bracelet Feu Du Dragon" 
                                    data-price="30.25" 
                                    data-image="/newaddina/assets/imgs/furniture/product/yy.png">
                                <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M13.0768 10.1416C13.0768 11.9228 11.648 13.3666 9.88542 13.3666C8.1228 13.3666 6.69401 11.9228 6.69401 10.1416M1.375 5.84163H18.3958M1.375 5.84163V12.2916C1.375 19.1359 2.57494 20.3541 9.88542 20.3541C17.1959 20.3541 18.3958 19.1359 18.3958 12.2916V5.84163M1.375 5.84163L2.91454 2.73011C3.27495 2.00173 4.01165 1.54163 4.81754 1.54163H14.9533C15.7592 1.54163 16.4959 2.00173 16.8563 2.73011L18.3958 5.84163" 
                                          stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                  ...
                  <div class="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="product-item furniture__product">
                      ...
                      <div class="product-thumb theme-bg-2">
                        <a href="product-details.html"
                          ><img
                            src="assets/imgs/furniture/product/uu.png"
                            alt=""
                        /></a>
                        <div class="product-action-item">
                          <button type="button" class="product-action-btn add-to-cart"
                                    data-name="Bracelet Onyx" 
                                    data-price="30.25" 
                                    data-image="/newaddina/assets/imgs/furniture/product/uu.png">
                                <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M13.0768 10.1416C13.0768 11.9228 11.648 13.3666 9.88542 13.3666C8.1228 13.3666 6.69401 11.9228 6.69401 10.1416M1.375 5.84163H18.3958M1.375 5.84163V12.2916C1.375 19.1359 2.57494 20.3541 9.88542 20.3541C17.1959 20.3541 18.3958 19.1359 18.3958 12.2916V5.84163M1.375 5.84163L2.91454 2.73011C3.27495 2.00173 4.01165 1.54163 4.81754 1.54163H14.9533C15.7592 1.54163 16.4959 2.00173 16.8563 2.73011L18.3958 5.84163" 
                                          stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                      ...
                      <div class="product-content">
                        <h4 class="product-title">
                          <a href="product-details.html">Bracelet Onyx</a>
                        </h4>
                        <div class="user-rating mb-1">
                          <i class="far fa-star"></i>
                          <i class="far fa-star"></i>
                  ...
                  <div class="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="product-item furniture__product">
                      <div class="product-thumb theme-bg-2">
                        <a href="product-details.html"
                          ><img
                            src="assets/imgs/furniture/product/dd.png"
                            alt=""
                        /></a>
                        <div class="product-action-item">
                          <button type="button" class="product-action-btn add-to-cart"
                                    data-name="Bracelet en céramique gris et blanc" 
                                    data-price="30.25" 
                                    data-image="/newaddina/assets/imgs/furniture/product/dd.png">
                                <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M13.0768 10.1416C13.0768 11.9228 11.648 13.3666 9.88542 13.3666C8.1228 13.3666 6.69401 11.9228 6.69401 10.1416M1.375 5.84163H18.3958M1.375 5.84163V12.2916C1.375 19.1359 2.57494 20.3541 9.88542 20.3541C17.1959 20.3541 18.3958 19.1359 18.3958 12.2916V5.84163M1.375 5.84163L2.91454 2.73011C3.27495 2.00173 4.01165 1.54163 4.81754 1.54163H14.9533C15.7592 1.54163 16.4959 2.00173 16.8563 2.73011L18.3958 5.84163" 
                                          stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                      ...
                      <div class="product-content">
                        <h4 class="product-title">
                          <a href="product-details.html"
                            >Bracelet en céramique gris et blanc</a
                          >
                        </h4>
                        <div class="user-rating mb-1">
                          <i class="far fa-star"></i>
        ...
        <div class="container">
          <div class="row g-4">
            <div class="col-xxl-7 col-xl-6">
              <div
                class="furniture-ad__item h-100 bg-image"
              ...
              >
                <div class="fad-content">
                  ...
                  <h2 class="text-capitalize text-white">
                    Bracelet limit offer <br />
                    30% Off
                  </h2>
                  <a class="border__btn-f mt-35" href="product-details.html"
                    >Buy Now<span
                      ><i class="fa-regular fa-angle-right"></i></span
                  ></a>
                </div>
            ...
            <div class="col-xxl-5 col-xl-6">
              ...
              >
                <div class="fad-content fad-timer text-center">
                  ...
                  <h2 class="text-capitalize text-white mb-30">
                    Deals OF the Week
                  </h2>
                  ...
                  <a class="border__btn-f mt-40" href="product-details.html"
                    >Buy Now<span
                      ><i class="fa-regular fa-angle-right"></i></span
                  ></a>
                </div>
      ...
      <section
        class="furniture-testimonial section-space bg-image"
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="furniture-testimonial__item">
                  ...
                  <p>
                    Not only the service was great , but also the product is
                    High quality.
                  </p>
                </div>
              </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
              <div class="furniture-seller__item">
                ...
                <div class="fs-content">
                  <h5>
                    <a href="product-details.html" class="text-capitalize"
                      >stylish grey chair</a
                    >
                  </h5>
                  <span>USD 66.00</span>
                  <div class="fs-rating">
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-xxl-4 col-xl-4 col-lg-4">
              <div
                class="section-title-wrapper-4 text-center section-title-space"
              >
            ...
            <div class="col-xxl-6 col-xl-6 col-lg-6">
              <div class="blog-item-4 furniture__blog-item">
                <div class="blog-content-4">
                  ...
                  <h4 class="blog-title">
                    <a href="blog-details.html" class="text-capitalize"
                      >arrangement that's nearly perfect.</a
                    >
                  </h4>
                  <a class="round-link" href="blog-details.html"
                    ><i class="fa-regular fa-angle-right"></i
                  ></a>
                </div>
            ...
            <div class="col-xxl-6 col-xl-6 col-lg-6">
              <div class="blog-item-4 furniture__blog-item">
                <div class="blog-content-4">
                  ...
                  <h4 class="blog-title">
                    <a href="blog-details.html" class="text-capitalize"
                      >Eworkstation arrangement that's</a
                    >
                  </h4>
                  <a class="round-link" href="blog-details.html"
                    ><i class="fa-regular fa-angle-right"></i
            ...
            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
              <div class="support-item">
                <div class="support-content">
                  ...
                  <a class="join-btn furniture-btn" href="#"
                    >sing up<span
                      ><i class="fa-regular fa-angle-right"></i></span
                  ></a>
                </div>
                ...
                <div class="support-content">
                  ...
                  <div class="mobile__app-download">
                    <a class="app__download" href="#">
                      <img
                        src="assets/imgs/app/play-store.png"
                        alt="image not found"
                      />
                    </a>
                    <a class="app__download" href="#">
                      <img
                        src="assets/imgs/app/apple-store.png"
                        alt="image not found"
                      />
                    </a>
                  </div>
