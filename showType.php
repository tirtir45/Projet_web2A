      ...
      <ul class="navbar-nav">
          <li class="nav-item">
              <a class="nav-link text-white active bg-gradient-primary" href="#">
                  ...
                  <span class="nav-link-text ms-1">Configuration des Types </span>
              </a>
          </li>
        ...
        <div class="col-md-7 mt-4">
          <div class="card">
            <div class="card-header pb-0 px-3">
              <h6 class="mb-0"> DETAIL DE  Type </h6>
            </div>
            <div class="card-body pt-4 p-3">
              <ul class="list-group">
                <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                  <div class="d-flex flex-column">
                    <h6 class="mb-3 text-sm">   <?= $type["id"]; ?> </h6>
                    <span class="mb-2 text-xs">id :  <span class="text-dark font-weight-bold ms-sm-2">    <?= $type["id"]; ?> </span></span>
                    <span class="mb-2 text-xs">Type_produit : <span class="text-dark ms-sm-2 font-weight-bold">   <?= $type["type_produit"]; ?></span></span>
                    <span class="mb-2 text-xs">Id_produit  : <span class="text-dark ms-sm-2 font-weight-bold">   <?= $type["produit_id"] ?></span></span>
                   </div>
                </li>
                <button class="btn btn-outline-primary btn-sm mb-0"> <a    href="listeType.php"> Retour
                                            à la liste </a></button>
              </ul>
            </div>
          </div>
