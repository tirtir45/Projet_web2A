                                            ...
                                            <div class="d-flex flex-column">
                                                <h6 class="mb-1 text-dark font-weight-bold text-sm">
                                                    ...
                                                    <select id="type" name="type">
                                                        <option value="S" <?php if ($oldproduit['type'] == 'S') echo 'selected' ?>>S</option>
                                                        <option value="M" <?php if ($oldproduit['type'] == 'M') echo 'selected' ?>>M</option>
                                                        <option value="L" <?php if ($oldproduit['type'] == 'L') echo 'selected' ?>>L</option>
                                                        <option value="XL" <?php if ($oldproduit['type'] == 'XL') echo 'selected' ?>>XL</option>
                                                    </select>
                                                </h6>
                                            </div>
                                        </li>
